...
if ( $is -eq 1 ) {
  ...
  # Download Defender for Endpoint Installer Script
  $mtime = Get-Date
  lwrite("Download Local Onboarding Script")
  (New-Object System.Net.WebClient).DownloadFile('https://${storage_acct_d}.blob.core.windows.net/${storage_container_d}/WindowsDefenderATPOnboardingScript.cmd}', 'C:\terraform\WindowsDefenderATPOnboardingScript.cmd')
...
lwrite("Installing Defender for Endpoint on System")
Start-Process -FilePath 'cmd.exe' -ArgumentList '/c C:\terraform\WindowsDefenderATPOnboardingScript.cmd' -Verb RunAs\
